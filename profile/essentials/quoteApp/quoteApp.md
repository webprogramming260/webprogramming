...
1.  Open up ChatGTP and give it the application creation prompt.
...
Before you break for lunch day you huddle with the product team and show them the prototype that you and your team created. You record their feedback and add it to your task list to work on later that after noon. The feedback includes:

1. Display the author
1. Remove the source footer and replace it with your companies subscription plea
1. Make the button a different color, perhaps amber or purple.
1. Make the heading say "Programming Quote"

## ☑ Assignment

Follow the above scenario and create your own website using GitHub Pages and Chat. You don't have to understand all of the generated HTML, but you should discuss it with Chat if there are things that are unclear. Make some minor tweaks to the page and redeploy it.
